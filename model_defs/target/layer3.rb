  ...
  nws.register do
    network 'target-L3' do
      ...
      node 'Seg.A' do
        ...
        term_point 'p3' do
          support %w[target-L2 HYP1-vSW1-BR-VL10 p3]
        end
        term_point 'p4' do
          support %w[target-L2 SW2-BR-VL10 p4]
        end
        support %w[target-L2 R1-BR-VL10]
        support %w[target-L2 R2-BR-VL10]
        support %w[target-L2 SW1-BR-VL10]
        support %w[target-L2 SW2-BR-VL10]
        support %w[target-L2 HYP1-vSW1-BR-VL10]
      end
      node 'Seg.B' do
        attribute(
        ...
        (0..2).each { |n| term_point "p#{n}" }
        term_point 'p3' do
          support %w[target-L2 HYP1-vSW1-BR-VL20 p3]
        end
        term_point 'p4' do
          support %w[target-L2 SW2-BR-VL20 p4]
        end
        support %w[target-L2 R1-BR-VL20]
        support %w[target-L2 R2-BR-VL20]
        support %w[target-L2 SW1-BR-VL20]
        support %w[target-L2 SW2-BR-VL20]
        support %w[target-L2 HYP1-vSW1-BR-VL20]
      end
      ...
      node 'Seg.C' do
        ...
        term_point 'p1' do
          support %w[target-L2 HYP1-vSW1-BR-VL30 p3]
        end
        term_point 'p2' do
          support %w[target-L2 SW2-BR-VL30 p3]
        end
        support %w[target-L2 SW1-BR-VL30]
        support %w[target-L2 SW2-BR-VL30]
        support %w[target-L2 HYP1-vSW1-BR-VL30]
      end
